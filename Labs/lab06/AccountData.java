...
public class AccountData implements Keyable {
  ...
  public void withdraw(int amt){
    if(amt < 0) System.out.println("Error:  Tried to withdraw less than 0: " + amt);
    else if(amt <= balance) balance = balance - amt;
    else System.out.println("Error:  Insufficient funds: " + amt);
  }
  ...
  public void deposit(int amt) throws BadTransactionException{
    ...
    else throw new BadTransactionException(amt);
  }
