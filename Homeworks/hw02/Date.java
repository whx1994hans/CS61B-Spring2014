...
class Date {
  ...
  public Date(String s) {
    String[] date = s.split("/");
    if(date.length != 3 || !date[0].matches("[0-9]+") ||
     !date[1].matches("[0-9]+") || !date[2].matches("[0-9]+")){
      System.exit(0);
    }
  ...
  public int dayInYear() {
    ...
    for(int i = 1; i < this.month; ++ i){
      dayOfYear += daysInMonth(i, this.year);
    }
    return dayOfYear + this.day;                           // replace this line with your solution
  }
  ...
  public static void main(String[] argv) {
    ...
    System.out.println("Test the isLeapYear function");
    ...
    System.out.println("Test daysInMonth function");
    System.out.println(daysInMonth(2, 1900));
    System.out.println(daysInMonth(2, 2000));
    System.out.println(daysInMonth(8, 2004));
    System.out.println(daysInMonth(7, 2004));
    System.out.println(daysInMonth(9, 2004));
    System.out.println("--------------------------------------");


    /* Test isValidDate function */
    System.out.println("Test isValidDate function");
    System.out.println(isValidDate(2, 29, 2000));
    System.out.println(isValidDate(2, 29, -1));
    System.out.println(isValidDate(2, 30, 2000));
    System.out.println(isValidDate(2, 29, 1900));
    System.out.println(isValidDate(8, 29, 2004));
    System.out.println(isValidDate(9, 29, 2004));
    System.out.println(isValidDate(9, 31, 2004));
    System.out.println(isValidDate(8, 33, 2004));
    System.out.println("--------------------------------------");
