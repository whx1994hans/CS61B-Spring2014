...
public class DList {
  ...
  public void insertAfter(Object item, DListNode node) {
    ...
    DListNode nodeTemp = newNode(item, node, node.next);
  ...
  public void insertBefore(Object item, DListNode node) {
    ...
    DListNode nodeTemp = newNode(item, node.prev, node);
    node.prev.next = nodeTemp;
    node.prev = nodeTemp;
    ++ size;
  }
  ...
  public static void main(String[] args){
    ...
    System.out.println("Create new DList " + list + " , the list is empty:" + list.isEmpty());
    ...
    DListNode next = list.next(front);
    System.out.println("Test next(): " + next.item);

    DListNode prev = list.prev(back);
