...
class SibTreeNode extends TreeNode {
  ...
  public void insertChild(Object item, int c) throws InvalidNodeException {
    ...
    if(isValidNode()){
      SibTreeNode child = this.firstChild;
      if(c < 1) c = 1;
      ...
      if(child == null){
        ...
        while((child.nextSibling != null) && (c > 2)){
  ...
  public void removeLeaf() throws InvalidNodeException {
    ...
    if(isValidNode()){
      if(firstChild == null){
        if(myTree.size == 1) myTree.root = null;
        else{
          ...
          if(child == this){
            ...
            while(child.nextSibling != this) child = child.nextSibling;
